package ke.co.locaden.shoppingcart.adapters;
...
import ke.co.locaden.databinding.CartRowBinding;
...
public class CartListAdapter extends ListAdapter<CartItems, CartListAdapter.CartVH> {
    ...
    public interface CartInterface{
        void deleteItem(CartItems cartItems);
        void changeQuantity(CartItems cartItems, int quantity);
    }
}
